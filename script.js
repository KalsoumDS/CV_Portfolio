const T = {
  fr: {
    ...
    'proof.intro': 'Six projets à fort impact technique — chacun conçu pour résoudre un problème réel, avec des résultats mesurables, des applications Streamlit Cloud et des démos interactives.',
    ...
    'proj.intro': 'Démos complètes avec données réelles — testez directement dans votre navigateur ou sur Streamlit Cloud.',
  ...
  en: {
    ...
    'proof.intro': 'Six high-impact technical projects — each built to solve a real problem, with measurable results, Streamlit Cloud apps and live interactive demos.',
    ...
    'proj.intro': 'Interactive demos and Streamlit Cloud deployed applications.',
    'proj.demo': 'Live demo →',
