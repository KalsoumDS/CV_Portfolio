const T = {
  fr: {
    ...
    'proof.finsight.title': 'Finsight — Stress-Testing & Analyse de Risque Financier',
    'proof.finsight.desc': 'Évaluation de la résilience financière des portefeuilles et PME face aux chocs de marché : calcul de VaR/CVaR, modélisation de volatilité et backtesting ML.',
    'proof.automl.title': 'ChatAutoML — Démocratisation de la Data Science par l\'IA',
    'proof.automl.desc': 'Permettre aux équipes non-techniciennes (ONG, PME) de transformer des données brutes en modèles optimisés via des instructions simples en langage naturel.',
    'proof.rag.title': 'Intelligence Documentaire RAG & Analyse de Politiques / ESG',
    'proof.rag.desc': 'Démocratisation de l\'accès aux textes réglementaires et rapports d\'impact (ESG, climat, droit du travail) : recherche vectorielle et réponses 100% sourcées via Mistral AI.',
    'proof.anomaly.title': 'Maintenance Prédictive Industrielle & Éco-Efficacité (IoT)',
    'proof.anomaly.desc': 'Prévention des pannes critiques sur équipements industriels et réduction des pertes d\'énergie : autoencodeur PyTorch sur séries temporelles de capteurs avec alerte <15 min avant rupture.',
    'proj.tag': 'Démos live',
  ...
  en: {
    ...
    'proof.finsight.title': 'Finsight — Financial Risk Analysis & Stress-Testing',
    'proof.finsight.desc': 'Evaluating portfolio and SME financial resilience against market shocks: VaR/CVaR calculation, volatility modeling, and ML-backed stress testing.',
    'proof.automl.title': 'ChatAutoML — Democratizing Data Science through Conversational AI',
    'proof.automl.desc': 'Empowering non-technical teams (NGOs, SMEs) to turn raw datasets into optimized predictive models using plain natural language commands.',
    'proof.rag.title': 'RAG Document Intelligence & Regulatory/ESG Analysis',
    'proof.rag.desc': 'Democratizing access to complex regulatory frameworks and sustainability reports (ESG/Policy): intelligent vector retrieval and 100% sourced answers powered by Mistral AI.',
    'proof.anomaly.title': 'Industrial Predictive Maintenance & Eco-Efficiency (IoT)',
    'proof.anomaly.desc': 'Preventing critical machinery failures and reducing energy waste: PyTorch sequential autoencoder on sensor time series with early anomaly detection <15 min before failure.',
