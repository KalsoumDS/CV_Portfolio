const T = {
  fr: {
    ...
    'proof.finsight.desc': 'Plateforme quantitative d\'analyse de portefeuille : calcul de VaR/CVaR paramétrique et historique, simulation Monte Carlo (10 000 scénarios), détection de régimes de marché par LSTM (F1 = 0.91) et backtesting XGBoost sur séries OHLCV.',
    'proof.automl.title': 'ChatAutoML — Plateforme No-Code d\'AutoML Conversationnel',
    'proof.automl.desc': 'Moteur d\'AutoML piloté par le langage naturel : optimisation bayésienne des hyperparamètres via Optuna (50+ trials), sélection automatique du meilleur modèle parmi 8 algorithmes, génération de rapport complet en <60s. Conçu pour ONG et PME sans expertise data.',
    'proof.rag.title': 'RAG Document Intelligence — Analyse ESG & Réglementaire par IA',
    'proof.rag.desc': 'Pipeline RAG structuré sur corpus de rapports ESG et textes réglementaires : chunking sémantique, indexation FAISS (cosine similarity), récupération top-k avec re-ranking, réponses 100% sourcées via Mistral AI. Précision de la récupération contextuelle >92% sur corpus de 500+ pages.',
    'proof.anomaly.title': 'Maintenance Prédictive Industrielle — Détection d\'Anomalies IoT',
    'proof.anomaly.desc': 'Autoencodeur LSTM-CNN PyTorch entraîné sur séries temporelles de capteurs industriels (vibration, température, pression) : détection d\'anomalies jusqu\'à 15 min avant rupture, recall = 0.97 sur jeu de test, réduction de 40% des arrêts non planifiés simulés.',
    'proof.cardio.title': 'Prédiction des Maladies Cardiovasculaires — Aide au Diagnostic',
    'proof.cardio.desc': 'Système d\'aide au diagnostic précoce des pathologies cardiovasculaires par Machine Learning (Random Forest, XGBoost, LightGBM) : classification multi-paramètres cliniques, analyse d\'importance des variables et explicabilité des prédictions.',
    'proj.tag': 'Démos Live',
  ...
  en: {
    ...
    'proof.finsight.desc': 'Quantitative portfolio analysis platform: parametric and historical VaR/CVaR, Monte Carlo simulation (10,000 scenarios), LSTM market regime detection (F1 = 0.91) and XGBoost backtesting on OHLCV series.',
    'proof.automl.title': 'ChatAutoML — Conversational No-Code AutoML Platform',
    'proof.automl.desc': 'Natural language-driven AutoML engine: Bayesian hyperparameter optimization via Optuna (50+ trials), automatic selection of the best model from 8 algorithms, complete report generated in <60s. Designed for NGOs and SMEs without data expertise.',
    'proof.rag.title': 'RAG Document Intelligence — ESG & Regulatory AI Analysis',
    'proof.rag.desc': 'Structured RAG pipeline over ESG reports and regulatory corpora: semantic chunking, FAISS indexing (cosine similarity), top-k retrieval with re-ranking, 100% sourced answers via Mistral AI. Contextual retrieval accuracy >92% on 500+ page corpus.',
    'proof.anomaly.title': 'Industrial Predictive Maintenance — IoT Anomaly Detection',
    'proof.anomaly.desc': 'LSTM-CNN PyTorch autoencoder trained on industrial sensor time series (vibration, temperature, pressure): anomaly detection up to 15 minutes before failure, recall = 0.97 on test set, 40% reduction in simulated unplanned downtime.',
    'proof.cardio.title': 'Cardiovascular Disease Prediction — Clinical Diagnostic Support',
    'proof.cardio.desc': 'Early diagnostic support system for cardiovascular diseases using Machine Learning (Random Forest, XGBoost, LightGBM): multi-parameter clinical classification, feature importance analysis and interpretable predictions.',
    'proj.tag': 'Live Demos',
